 ...
 \brief Страница, демонстрирующая аксессуары
 \code
 <!DOCTYPE html>
  <html lang = "ru">
 <head>
 ...
 $result = mysqli_query($mysql, "SELECT * FROM `computers` WHERE type = 'accesory'");
while($row = $result->fetch_assoc())
 ...
 echo'
     ...
     <div class="product-bottom">
       ...
       <td><a style="color: green;"href="bucket.php?id='.$accessory[0].'">Добавить в корзину</a></td>
       </tr>
       </div>
